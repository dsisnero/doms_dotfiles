...
function RunSpacemacs {
  docker run -it --rm `
    ...
    -v "$HOME/repos/github.com/dsisnero/doms_dotfiles/config/SKK-JISYO.L:/root/.skk-jisyo" `
    -v "$HOME/repos/github.com/dsisnero/doms_dotfiles/config/.spacemacs:/root/.spacemacs" `
