...
when "debian", "mint", "ubuntu"
  ...
  apt_repository "mise" do
    ...
    content "deb [arch=amd64] https://mise.jdx.dev/deb stable main" # This line will be generated by the content block below
    ...
    url "deb [arch=amd64] https://mise.jdx.dev/deb stable main"
